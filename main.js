...
const scrollRevealOption = {
  ...
  origin: "bottom",
  duration: 1000,
  mobile: true, // Ensures animations work on mobile devices
  reset: true,  // Allows animations to reset when scrolling back
};
...
ScrollReveal().reveal(".instagram__flex img", {
  ...scrollRevealOption,
  interval: 200, // Adds a delay between each image animation
});
